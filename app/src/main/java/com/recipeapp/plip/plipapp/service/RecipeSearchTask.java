...
/**
 * A class extending the AsyncTask abstract class with the specific intent of returning a SearchResultsModel
 * from a remote API call
 */
public class RecipeSearchTask extends AsyncTask<String,String,SearchResultsModel> {
    ...
    protected void onPostExecute(SearchResultsModel searchResultsModel) {
        ...
        recipeCallbackListener.onSearchCallback(searchResultsModel);
    }
}